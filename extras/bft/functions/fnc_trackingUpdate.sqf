 ...
 *
 * Example:
 * call xgrps_bft_fnc_trackingUpdate
 *
 * Public: No
 */

if ((isNil "xgrps_unit") && (!alive xgrps_unit)) exitWith {};
...
if (GVAR(requireItemGPS) && !([xgrps_unit] call FUNC(hasGPSDevice))) exitWith {};
