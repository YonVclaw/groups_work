...
if (isMultiplayer && hasInterface) then {
    QGVAR(fps) addPublicVariableEventHandler {
        ...
        private _ctrl = (uiNamespace getVariable [QGVAR(display), displayNull]) displayCtrl IDC_XGRPS_ADMINMENU_FPS;
    ...
    QGVAR(headlessInfo) addPublicVariableEventHandler {
        ...
        private _ctrl = ((uiNamespace getVariable [QGVAR(display), displayNull]) displayCtrl IDC_XGRPS_ADMINMENU_G_DASH) controlsGroupCtrl IDC_XGRPS_ADMINMENU_DASH_HEADLESS;
        if (isNull _ctrl) exitWith {};
    ...
    QGVAR(currentAdmin) addPublicVariableEventHandler {
        ...
        private _ctrl = ((uiNamespace getVariable [QGVAR(display), displayNull]) displayCtrl IDC_XGRPS_ADMINMENU_G_DASH) controlsGroupCtrl IDC_XGRPS_ADMINMENU_DASH_CURRADMIN;
        if (isNull _ctrl) exitWith {};
