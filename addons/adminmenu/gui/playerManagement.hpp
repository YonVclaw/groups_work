class Controls
{
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_FILTER_SIDE;
        sizeEx = QUOTE(XGRPS_ADMINMENU_STD_SIZEX);
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_REFRESH;
        text = "Refresh";
    ...
    class BackgroundGroupList: RscText
    {
        ...
        w = QUOTE(XGRPS_ADMINMENU_PMAN_W_LISTGROUP);
        h = QUOTE(XGRPS_ADMINMENU_PMAN_H_LISTGROUP);
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_LIST;
    ...
    */
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_SEL_ALL;
        text = "All";
        x = "30.9 * (((safezoneW / safezoneH) min 1.2) / 40)";
        y = "1.1 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = "6.9 * (((safezoneW / safezoneH) min 1.2) / 40)";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_SEL_NONE;
        text = "None";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_SEL_INVERT;
        text = "Invert";
    ...
    // {
    //     idc = IDC_XGRPS_ADMINMENU_PMAN_ACRELANGUAGES;
    ...
    // {
    //     idc = IDC_XGRPS_ADMINMENU_PMAN_ACRERADIOS;
    //     text = "ACRE2 Radios";
    ...
    // {
    //     idc = IDC_XGRPS_ADMINMENU_PMAN_ASSIGNGEAR;
    //     text = "Assign Gear";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_ASSIGNTRAITS;
        text = "Assign Traits";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_GRANTZEUS;
        text = "Grant Zeus";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_HEAL;
        text = "Heal";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_MESSAGE;
        text = "Message";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_QRESPAWN;
        text = "Quick Respawn";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_RUNCODE;
        text = "Run Code On";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_STEAM;
        text = "Steam Profile";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_PMAN_TELEPORT;
        text = "Teleport";
