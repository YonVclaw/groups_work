class Controls
{
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_FROMMISSION;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_LIST;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_FROMMISSION_ISDEFEAT;
        onCheckedChanged = "";
        x = "0";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_ENDMISSION;
        text = "End Mission";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_EXPORTAAR;
        onCheckedChanged = "";
        x = "32.3 * (((safezoneW / safezoneH) min 1.2) / 40)";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_ACTIVATEHUNT;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_SIDESPECIFIC;
        onCheckedChanged = QUOTE([ARR_2(ctrlParent (param [0]),ctrlIDC (param [0]))] call FUNC(endMission_occluder););
        x = "25.2 * (((safezoneW / safezoneH) min 1.2) / 40)";
    };
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_BLUFOR;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_OPFOR;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_INDEP;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_CIVILIAN;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_SIDEDRAW;
        onCheckedChanged = "";
        x = "25.2 * (((safezoneW / safezoneH) min 1.2) / 40)";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_CUSTOM;
        onCheckedChanged = QUOTE([ARR_2(ctrlParent (param [0]),ctrlIDC (param [0]))] call FUNC(endMission_occluder););
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_CUSTOM_TITLE;
        colorBackground[] = {0.5, 0.5, 0.5, 0.1};
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_CUSTOM_SUBTEXT;
        y = "18.3 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
    };
    class CheckboxCustomEndingDefeat: CheckboxUseMissionEnding
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_CUSTOM_ISDEFEAT;
        onCheckedChanged = "";
        x = "0";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_OCCLUDER_LU;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_OCCLUDER_LD;
        y = "17.2 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
        w = "24.2 * (((safezoneW / safezoneH) min 1.2) / 40)";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_ENDM_OCCLUDER_R;
