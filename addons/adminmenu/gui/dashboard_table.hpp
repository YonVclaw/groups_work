...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_BLUFOR_AI;
    text = "";
    colorBackground[] = {0.5, 0.5, 0.5, 0.1};
    y = "2.2 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_BLUFOR_PLAYERS;
    text = "";
    colorBackground[] = {0.5, 0.5, 0.5, 0.1};
    y = "2.2 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_BLUFOR_SPECTATORS;
    text = "";
    colorBackground[] = {0.5, 0.5, 0.5, 0.1};
    y = "2.2 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_BLUFOR_TOTAL;
    text = "";
    colorBackground[] = {0.5, 0.5, 0.5, 0.1};
    y = "2.2 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_OPFOR_AI;
    text = "";
    colorBackground[] = {1, 1, 1, 0.1};
    y = "3.3 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_OPFOR_PLAYERS;
    text = "";
    colorBackground[] = {1, 1, 1, 0.1};
    y = "3.3 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_OPFOR_SPECTATORS;
    text = "";
    colorBackground[] = {1, 1, 1, 0.1};
    y = "3.3 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_OPFOR_TOTAL;
    text = "";
    colorBackground[] = {1, 1, 1, 0.1};
    y = "3.3 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_INDEP_AI;
    y = "4.4 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
class UnitStats_Players_Indep: UnitStats_Players_Blufor
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_INDEP_PLAYERS;
    y = "4.4 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
class UnitStats_Spectators_Indep: UnitStats_Spectators_Blufor
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_INDEP_SPECTATORS;
    y = "4.4 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
class UnitStats_Total_Indep: UnitStats_Total_Blufor
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_INDEP_TOTAL;
    y = "4.4 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_CIV_AI;
    y = "5.5 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
class UnitStats_Players_Civilian: UnitStats_Players_Opfor
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_CIV_PLAYERS;
    y = "5.5 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
class UnitStats_Spectators_Civilian: UnitStats_Spectators_Opfor
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_CIV_SPECTATORS;
    y = "5.5 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
class UnitStats_Total_Civilian: UnitStats_Total_Opfor
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_CIV_TOTAL;
    y = "5.5 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
...
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_TOTAL_AI;
    y = "6.6 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
class UnitStats_Players_Total: UnitStats_Players_Blufor
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_TOTAL_PLAYERS;
    y = "6.6 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
class UnitStats_Spectators_Total: UnitStats_Spectators_Blufor
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_TOTAL_SPECTATORS;
    y = "6.6 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
class UnitStats_Total_Total: UnitStats_Total_Blufor
{
    idc = IDC_XGRPS_ADMINMENU_DASH_STATS_TOTAL_TOTAL;
    y = "6.6 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
};
