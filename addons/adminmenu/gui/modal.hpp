class GVAR(modal)
{
    ...
    class Controls
    {
        ...
        {
            idc = IDC_XGRPS_ADMINMENU_MODAL_BACK;
        ...
        {
            idc = IDC_XGRPS_ADMINMENU_MODAL_TBACK;
        ...
        {
            idc = IDC_XGRPS_ADMINMENU_MODAL_TITLE;
        ...
        {
            idc = IDC_XGRPS_ADMINMENU_MODAL_GBACK;
        ...
        {
            idc = IDC_XGRPS_ADMINMENU_G_MODAL;
        ...
        class Close
        {
            idc = IDC_XGRPS_ADMINMENU_MODAL_CLOSE;
            type = 1;
            style = "48 + 2048";
