class Controls
{
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_SPECTATORTEXT;
        ...
        x = 0;
        y = 0;
        w = QUOTE(XGRPS_ADMINMENU_RESP_W_COL1);
        h = QUOTE(XGRPS_ADMINMENU_STD_HEIGHT);
    };
    class spectatorListBox: RscListBox
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_SPECTATORLIST;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_ADDBUTTON;
        text = "Add";
        x = QUOTE(XGRPS_ADMINMENU_RESP_X_COL2);
        y = "1.1 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = QUOTE(XGRPS_ADMINMENU_RESP_W_COL2);
        h = QUOTE(XGRPS_ADMINMENU_STD_HEIGHT);
        onButtonClick=QUOTE((ctrlParent (param [0])) call FUNC(respawn_addAction));
    };
    class respawnMenuRemoveButton: GVAR(RscButtonMenu)
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_REMOVEBUTTON;
        text = "Remove";
        x = QUOTE(XGRPS_ADMINMENU_RESP_X_COL2);
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_ROLECOMBO;
        text = "Role";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_RANK;
        ...
        w = QUOTE(XGRPS_ADMINMENU_RESP_W_COL2);
        h = QUOTE(2*XGRPS_ADMINMENU_STD_HEIGHT);
    };

    // class respawnMenuVOIP: GVAR(RscButtonMenu)
    // {
    //     idc = IDC_XGRPS_ADMINMENU_RESP_SPECTATORVOIP;
    //     text = "Toggle Spectator VOIP";
    //     x = QUOTE(XGRPS_ADMINMENU_RESP_X_COL3);
    //     y = "0";
    //     w = QUOTE(XGRPS_ADMINMENU_RESP_W_COL3);
    //     h = QUOTE(XGRPS_ADMINMENU_STD_HEIGHT);
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_GROUPLIST;
    ...
    class respawnGroupDetailsText: RscText
    {
        ...
        x = QUOTE(XGRPS_ADMINMENU_RESP_X_COL4);
        y = "1.1 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = QUOTE(XGRPS_ADMINMENU_RESP_W_COL1);
        h = QUOTE(XGRPS_ADMINMENU_STD_HEIGHT);
    };
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_GROUPNAME;
        ...
        x = QUOTE(XGRPS_ADMINMENU_RESP_X_COL4);
        y = "2.2 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = QUOTE(XGRPS_ADMINMENU_RESP_W_COL4);
        h = QUOTE(XGRPS_ADMINMENU_STD_HEIGHT);
    };
    class respawnMenuFactionCategoryCombo: RscCombo
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_FACTIONCATEGORY;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_FACTION;
        text = "Faction";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_SIDE;
        text = "Side";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_GROUPMARKERCHECKBOX;
        text = "Give group marker";
        x = QUOTE(XGRPS_ADMINMENU_RESP_X_COL4 + (7 * (((safezoneW / safezoneH) min 1.2) / 40)));
        y = "7.7 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = "(1 * (((safezoneW / safezoneH) min 1.2) / 40))";
        h = QUOTE(XGRPS_ADMINMENU_STD_HEIGHT);
        //action = "['respawnMenuToggleGroupCheckbox'] spawn xgrps_respawn_fnc_handleRespawnUI";
    };
    class respawnMenuMarkerName: RscEdit
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_GROUPMARKERNAME;
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_MARKERTYPE;
        text = "Side";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_MARKERCOLOUR;
        text = "Side";
    ...
    {
        idc = IDC_XGRPS_ADMINMENU_RESP_SPAWNBUTTON;
        text = "Spawn Group";
        x = QUOTE(XGRPS_ADMINMENU_RESP_X_COL4);
    ...
    // {
        ...
        // h = 0.055 * safezoneH;
        // action="['respawnMenuChangeRoleAction'] spawn xgrps_respawn_fnc_handleRespawnUI";
    // };
    ...
    // {
        ...
        // w = 0.0567187 * safezoneW;
        // h = 0.055 * safezoneH;
        // action="['respawnMenuChangeRankAction'] spawn xgrps_respawn_fnc_handleRespawnUI";
    // };
};
