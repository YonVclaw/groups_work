...
// [COMPONENT_NAME, QGVAR(spectatorRemoteControl), ["Control Focused Spectator Unit", "Only available in 61st Mechanized Infantry Battalion Spectator, and only for admins and in singleplayer"], FUNC(keyPressed), {false}, [0, [false, false, false]], false, 0] call CBA_fnc_addKeybind; // No default bind
