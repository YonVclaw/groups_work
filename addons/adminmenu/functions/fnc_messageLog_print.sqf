...
/* ----------------------------------------------------------------------------
Internal Function: XGRPS_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call XGRPS_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_XGRPS_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[61st Mechanized Infantry Battalion Adminmenu] Printed entry: %1%2",
