...
_ctrlCheckFaction ctrlSetPosition [0, 0, XGRPS_ADMINMENU_STD_WIDTH, XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelFaction ctrlSetPosition [XGRPS_ADMINMENU_STD_WIDTH, 0, (0.25 * _ctrlGrpWidth), XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlCheckFromMission ctrlSetPosition [(2 * XGRPS_ADMINMENU_STD_WIDTH) + (0.25 * _ctrlGrpWidth), 0, XGRPS_ADMINMENU_STD_WIDTH, XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelFromMission ctrlSetPosition [(3 * XGRPS_ADMINMENU_STD_WIDTH) + (0.25 * _ctrlGrpWidth), 0, (0.6 * _ctrlGrpWidth), XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlComboFaction ctrlSetPosition [(0.1 * XGRPS_ADMINMENU_STD_WIDTH), (1.1 * XGRPS_ADMINMENU_STD_HEIGHT), _ctrlGrpWidth - (0.2 * XGRPS_ADMINMENU_STD_WIDTH), XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelBracketNumbers ctrlSetPosition [0, (2.2 * XGRPS_ADMINMENU_STD_HEIGHT), _ctrlGrpWidth, XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelRoles ctrlSetPosition [0, (4.2 * XGRPS_ADMINMENU_STD_HEIGHT), (0.25 * _ctrlGrpWidth), XGRPS_ADMINMENU_STD_HEIGHT];
_ctrlLabelRoles ctrlCommit 0;
_ctrlLabelRoles ctrlSetText "Change Roles";

private _ctrlGrpRolesWidth = _ctrlGrpWidth - (0.2 * XGRPS_ADMINMENU_STD_WIDTH);
private _ctrlGrpRoles = _display ctrlCreate ["RscControlsGroup", -1, _ctrlGroup];
GVAR(utilityTabControls) pushBack _ctrlGrpRoles;
_ctrlGrpRoles ctrlSetPosition [(0.1 * XGRPS_ADMINMENU_STD_WIDTH), (5.3 * XGRPS_ADMINMENU_STD_HEIGHT), _ctrlGrpRolesWidth, _ctrlGrpHeight - (6.4 * XGRPS_ADMINMENU_STD_HEIGHT)];
...
private _ctrlComboRoleW = (0.5 * _ctrlGrpRolesWidth) - XGRPS_ADMINMENU_STD_WIDTH;
private _ctrlCheckChangeX = _ctrlGrpRolesWidth - XGRPS_ADMINMENU_STD_WIDTH;
{
    private _ctrlLineY = _forEachIndex * (1.1 * XGRPS_ADMINMENU_STD_HEIGHT);
    ...
    _ctrlLabelPlayer ctrlSetPosition [0, _ctrlLineY, _ctrlLabelPlayerW, XGRPS_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlComboRole ctrlSetPosition [_ctrlComboRoleX, _ctrlLineY, _ctrlComboRoleW, XGRPS_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlCheckChange ctrlSetPosition [_ctrlCheckChangeX, _ctrlLineY, XGRPS_ADMINMENU_STD_WIDTH, XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlSetPosition [_ctrlGrpWidth * 0.8, _ctrlGrpHeight - XGRPS_ADMINMENU_STD_HEIGHT, _ctrlGrpWidth * 0.2, XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlAddEventHandler ["ButtonClick", {
    ...
    systemChat format ["[61st Mechanized Infantry Battalion Admin Menu] Assigned gear to %1 players", count GVAR(utility_assigngear_rolectrls)];
}];
