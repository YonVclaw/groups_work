...
private _control = (_display displayCtrl IDC_XGRPS_ADMINMENU_RESP_FACTION);  /* Faction Control */
...
private _control = (_display displayCtrl IDC_XGRPS_ADMINMENU_RESP_ROLECOMBO); /* Role control */ 
lbClear _control;
respawnMenuRoles = [];
{
