...
if (_error isEqualTo "") then {
    ...
    [{!dialog}, {
        ...
        [{
            ...
            systemChat format [
                "[61st Mechanized Infantry Battalion Admin Menu] Remote Control stopped because: %1",
                _reasons joinString " | "
            ];
    ...
    systemChat format [
        "[61st Mechanized Infantry Battalion Admin Menu] Spectator Remote Control error: %1",
        _error
    ];
};
