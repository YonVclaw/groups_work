...
/* ----------------------------------------------------------------------------
Function: XGRPS_adminmenu_fnc_log
...
Examples:
    (begin example)
        ["Everything is on fire!",true,"[61st Mechanized Infantry Battalion Firealarm]"] call XGRPS_adminmenu_fnc_log;
    (end)
    (begin example)
        [format ["%1 did something",profileName]] call XGRPS_adminmenu_fnc_log;
    (end)
