...
_ctrlLabelRadios ctrlSetPosition [0, 0, (0.5 * _ctrlGrpWidth), XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelRadioGroup ctrlSetPosition [0, (1.1 * XGRPS_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, XGRPS_ADMINMENU_STD_HEIGHT];
...
private _radioCtrls = [];
private _radioCtrlsY = 2.2 * XGRPS_ADMINMENU_STD_HEIGHT;

{
    ...
    _ctrlRadioCheck ctrlSetPosition [0, _radioCtrlsY + (_forEachIndex * XGRPS_ADMINMENU_STD_HEIGHT), XGRPS_ADMINMENU_STD_WIDTH, XGRPS_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlRadioName ctrlSetPosition [XGRPS_ADMINMENU_STD_WIDTH, _radioCtrlsY + (_forEachIndex * XGRPS_ADMINMENU_STD_HEIGHT), (0.5 * _ctrlGrpWidth) - XGRPS_ADMINMENU_STD_WIDTH, XGRPS_ADMINMENU_STD_HEIGHT];
...
if (!isNil QEGVAR(acre2,networksWithRadioChannels)) then {
    ...
    _ctrlCheckNetwork ctrlSetPosition [0.5 * _ctrlGrpWidth, 0, XGRPS_ADMINMENU_STD_WIDTH, XGRPS_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetwork ctrlSetPosition [(0.5 * _ctrlGrpWidth) + XGRPS_ADMINMENU_STD_WIDTH, 0, (0.5 * _ctrlGrpWidth) - (1.1 * XGRPS_ADMINMENU_STD_WIDTH), XGRPS_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetworkWarning ctrlSetPosition [0.5 * _ctrlGrpWidth, (1.1 * XGRPS_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, XGRPS_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlListNetwork ctrlSetPosition [0.5 * _ctrlGrpWidth, _radioCtrlsY, (0.5 * _ctrlGrpWidth) - (0.1 * XGRPS_ADMINMENU_STD_WIDTH), _ctrlGrpHeight - _radioCtrlsY - (2 * XGRPS_ADMINMENU_STD_HEIGHT)];
...
_ctrlButton ctrlAddEventHandler ["ButtonClick", {
    ...
    if !(_networkCtrls isEqualTo []) then {
        ...
        if (cbChecked _ctrlNetworkCheck) then {
            ...
            if (_idx < 0) exitWith {
                systemChat "[61st Mechanized Infantry Battalion Admin Menu] No network selected";
            };
