...
private _ctrlEditPos = [0.1 * XGRPS_ADMINMENU_STD_WIDTH, 0.1 * XGRPS_ADMINMENU_STD_HEIGHT, _ctrlGrpWidth - (0.2 * XGRPS_ADMINMENU_STD_WIDTH), _ctrlGrpHeight - (1.3 * XGRPS_ADMINMENU_STD_HEIGHT)];
...
_ctrlCombo ctrlSetPosition [0.1 * XGRPS_ADMINMENU_STD_WIDTH, _ctrlGrpHeight - XGRPS_ADMINMENU_STD_HEIGHT, _ctrlGrpWidth * 0.3, XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlButtonPreview ctrlSetPosition [(_ctrlGrpWidth * 0.7) - (0.2 * XGRPS_ADMINMENU_STD_WIDTH), _ctrlGrpHeight - XGRPS_ADMINMENU_STD_HEIGHT, (_ctrlGrpWidth * 0.15), XGRPS_ADMINMENU_STD_HEIGHT];
...
_ctrlButtonCommit ctrlSetPosition [(_ctrlGrpWidth * 0.85), _ctrlGrpHeight - XGRPS_ADMINMENU_STD_HEIGHT, (_ctrlGrpWidth * 0.15) - (0.1 * XGRPS_ADMINMENU_STD_WIDTH), XGRPS_ADMINMENU_STD_HEIGHT];
