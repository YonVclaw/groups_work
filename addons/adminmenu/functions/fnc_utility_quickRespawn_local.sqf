...
if (_oldUnitdata isEqualType []) then {
    ...
    //         if (isNil "xgrps_acre2_networksCreated") exitWith {}; //Ensure presets are created
    ...
    systemChat "[61st Mechanized Infantry Battalion Admin Menu] Quick Respawn failed: old unit data unavailable";
};
