...
private _list = _display displayCtrl IDC_XGRPS_ADMINMENU_PMAN_LIST;
private _filterSide = [sideUnknown, blufor, opfor, resistance, civilian] param [(lbCurSel (_display displayCtrl IDC_XGRPS_ADMINMENU_PMAN_FILTER_SIDE)) max 0];
private _filterState = (lbCurSel (_display displayCtrl IDC_XGRPS_ADMINMENU_PMAN_FILTER_STATE)) max 0;
