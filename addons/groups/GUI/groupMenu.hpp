...
class LXIF_groupMenu : RscDisplayTeamSwitch {
	idd=9702;
	name="LXIF_groupMenu";
	movingEnable=0;
	onLoad = "";
	...
	class Controls : Controls
	{
		...
		{
			text = "$STR_LXIF_Role_Menu_Title";
		};
		class RoleList : RscTree
		{
			idc = 1500;
			onTreeSelChanged = "_this call LXIF_fnc_onGroupMenuTvSelectChange;";
		...
		class SelectRoleBtn : CA_ButtonContinue
		{
			...
			onButtonClick = "[] call LXIF_fnc_selectPosition;";
		};
	};
};