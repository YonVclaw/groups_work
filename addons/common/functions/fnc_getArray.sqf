 ...
 *
 * Examples:
 * [configFile >> "thisIsAnArray"] call xgrps_common_fnc_getArray; // returns value in path
 * [configFile >> "thisIsNotAnArray"] call xgrps_common_fnc_getArray; // returns []
 * [configFile >> "thisIsAnArray", ['default']] call xgrps_common_fnc_getArray; // returns value in path
 * [configFile >> "thisIsNotAnArray", ['default']] call xgrps_common_fnc_getArray; // returns ['default']
 *
 * Public: Yes
 */
