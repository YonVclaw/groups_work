 ...
 *
 * Examples:
 * [1, 0, 0, 1] call xgrps_common_fnc_ensureBoundedMinMax; // returns [0,1]
 * [2, 0, 0, 1] call xgrps_common_fnc_ensureBoundedMinMax; // returns [0,1]
 * [0, 1, 0.5, 1] call xgrps_common_fnc_ensureBoundedMinMax; // returns [0.5, 1]
 *
 * Public: Yes
 */
