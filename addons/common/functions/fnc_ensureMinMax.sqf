 ...
 *
 * Examples:
 * [1, 0] call xgrps_common_fnc_ensureMinMax; // returns [0,1]
 * [2, 0] call xgrps_common_fnc_ensureMinMax; // returns [0,2]
 * [0, 1] call xgrps_common_fnc_ensureMinMax; // returns [0,1]
 *
 * Public: Yes
 */
